...
if ( ! function_exists( 'shoptheme_woo_before_main_content' ) ) :
    ...
    ?>
        ...
        <div class="site-shop" data-orderby="<?php echo esc_attr( $shoptheme_woo_orderby ); ?>" data-product-cat="<?php echo esc_attr( $shoptheme_get_product_cat_id ); ?>">
            <div class="container">
                <div class="row">
                    <?php
                    /**
...
if ( ! function_exists( 'shoptheme_woo_pagination_ajax' ) ) :
    ...
    function shoptheme_woo_pagination_ajax( $shoptheme_ajax_query, $vendor_ids = array(), $collection_ids = array() ) {
...
?>
        ...
        <div class="site-shop__pagination text-center">
            ...
            <button class="btn-global btn-load-product" data-pagination="2" data-limit-product="<?php echo esc_attr( $shoptheme_product_limit ); ?>" data-remaining-product="<?php echo esc_attr( $shoptheme_woo_total_product_remaining ); ?>" data-product-vendor="<?php echo esc_attr( $vendor_ids ) ?>" data-product-collection="<?php echo esc_attr( $collection_ids ) ?>">
...
function shoptheme_get_orderby_product( $shoptheme_orderby_product_value = '' ) {
    ...
    if ( !empty( $shoptheme_orderby_product_value ) ) :
        ...
        $shoptheme_orderby_value =  explode( '-', $shoptheme_orderby_product_value );
    ...
    return array(
        'shoptheme_product_orderby'         =>  $shoptheme_product_orderby,
        'shoptheme_product_order'           =>  $shoptheme_product_order,
        'shoptheme_product_order_meta_key'  =>  $shoptheme_product_order_meta_key
    );
...
function shoptheme_pagination_product() {
    ...
    if ( !empty( $shoptheme_vendor_ids ) ) :
        $shoptheme_vendor_ids = explode( ',', $shoptheme_vendor_ids );
    endif;

    if ( !empty( $shoptheme_collection_ids ) ) :
        $shoptheme_collection_ids = explode( ',', $shoptheme_collection_ids );
    endif;
