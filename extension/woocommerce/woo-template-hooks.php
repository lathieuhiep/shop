 ...
 * @see shoptheme_woo_pagination_ajax()
 */
...
add_action( 'shoptheme_woo_sidebar', 'shoptheme_woo_get_sidebar', 10 );
...
add_action( 'shoptheme_pagination_product', 'shoptheme_woo_pagination_ajax', 10, 3 );
